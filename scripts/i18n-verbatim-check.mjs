...
export const MIGRATED_SOURCES = [
  ...
  // Final registry, dynamic diagnostic and context-menu sweep (batches 13–14)
  'src/behaviors/Agv.ts',
  'src/behaviors/ChainTransfer.ts',
  'src/behaviors/Conveyor.ts',
  'src/behaviors/OverheadConveyor.ts',
  'src/behaviors/PickPlaceStationExample.ts',
  'src/behaviors/Sink.ts',
  'src/behaviors/Source.ts',
  'src/behaviors/Turntable.ts',
  'src/core/editor/rv-asset-library-save.ts',
  'src/core/editor/rv-save-document.ts',
  'src/core/engine/rv-gpu-info.ts',
  'src/core/engine/rv-script-host.ts',
  'src/core/engine/rv-script-sandbox.ts',
  'src/core/hmi/scene/scene-store.ts',
  'src/core/ops/rv-document-projection.ts',
  'src/core/ops/rv-document-recompose.ts',
  'src/core/ops/rv-reference-guard.ts',
  'src/core/rv-viewer.ts',
  'src/core/sdk/rv-component-sdk.ts',
  'src/core/sdk/rv-des-lint.ts',
  'src/plugins/kiosk-tour-api.ts',
  'src/plugins/mcp-bridge/rv-mcp-editor-tools.ts',
  'src/plugins/snap-point/index.ts',
  'src/plugins/web-component-plugin.ts',
];
...
const SMART_ASSET_EDITOR = 'No English original exists to move: the public Smart Asset Editor '
  + '(EP-ASSET-001) was added after the migration base ref. These strings define its new asset '
...
const SMART_ASSET_EDITOR_KEYS = [
  ...
  'assets.smartEditor.overview',
  'assets.smartEditor.ports',
  'assets.smartEditor.behavior',
  'assets.smartEditor.signals',
  'assets.smartEditor.validate',
  'assets.smartEditor.assetIdentity',
  'assets.smartEditor.assetName',
  'assets.smartEditor.selectedNode',
  'assets.smartEditor.selectHint',
  'assets.smartEditor.importGlb',
  'assets.smartEditor.hierarchy',
  'assets.smartEditor.newAsset',
  'assets.smartEditor.undo',
  'assets.smartEditor.redo',
  'assets.smartEditor.overviewHint',
  'assets.smartEditor.portHint',
  'assets.smartEditor.portId',
  'assets.smartEditor.typeId',
  'assets.smartEditor.flow',
  'assets.smartEditor.flowIn',
  'assets.smartEditor.flowOut',
  'assets.smartEditor.flowBoth',
  'assets.smartEditor.position',
  'assets.smartEditor.direction',
  'assets.smartEditor.addPort',
  'assets.smartEditor.templateHint',
  'assets.smartEditor.template',
  'assets.smartEditor.length',
  'assets.smartEditor.width',
  'assets.smartEditor.height',
  'assets.smartEditor.speed',
  'assets.smartEditor.pitch',
  'assets.smartEditor.processKind',
  'assets.smartEditor.applyTemplate',
  'assets.smartEditor.templateNames.metadata',
  'assets.smartEditor.processKinds.pretreat',
  'assets.smartEditor.processKinds.spray',
  'assets.smartEditor.processKinds.dry',
  'assets.smartEditor.processKinds.cool',
  'assets.smartEditor.processKinds.buffer',
  'assets.smartEditor.signalDirectionHint',
  'assets.smartEditor.signalName',
  'assets.smartEditor.signalType',
  'assets.smartEditor.comment',
  'assets.smartEditor.initialValue',
  'assets.smartEditor.boolHint',
  'assets.smartEditor.addSignal',
  'assets.smartEditor.nodes',
  'assets.smartEditor.meshes',
  'assets.smartEditor.templates',
  'assets.smartEditor.publishable',
  'assets.smartEditor.notPublishable',
  'assets.smartEditor.runValidation',
  'assets.smartEditor.publishLibrary',
  'assets.smartEditor.publishHint',
  'assets.smartEditor.confirmLeave',
  'assets.smartEditor.confirmNew',
  'assets.smartEditor.loading',
  'assets.smartEditor.importing',
  'assets.smartEditor.imported',
  'assets.smartEditor.saving',
  'assets.smartEditor.saved',
  'assets.smartEditor.draftRecovered',
  'assets.smartEditor.saveFailed',
  'assets.smartEditor.fixErrors',
  'assets.smartEditor.nameRequired',
  'assets.smartEditor.noAsset',
  'assets.smartEditor.viewerUnavailable',
  'assets.smartEditor.sourceUnavailable',
  'assets.smartEditor.namePrompt',
  'assets.smartEditor.saveAs',
  'assets.smartEditor.download',
  'assets.smartEditor.issues.assetEmpty',
  'assets.smartEditor.issues.nodeNameEmpty',
  'assets.smartEditor.issues.nodeIdDuplicate',
  'assets.smartEditor.issues.portInvalid',
  'assets.smartEditor.issues.portIdDuplicate',
  'assets.smartEditor.issues.portLegacyMismatch',
  'assets.smartEditor.issues.signalNameDuplicate',
  'assets.smartEditor.issues.signalNameEmpty',
  'assets.smartEditor.issues.trackPointsInvalid',
  'assets.smartEditor.issues.trackPortsMissing',
  'assets.smartEditor.issues.zoneKindInvalid',
  'assets.smartEditor.issues.zoneSizeInvalid',
  'assets.smartEditor.issues.controllerParamsInvalid',
  'assets.smartEditor.issues.robotParamsInvalid',
...
export const NEW_STRING_EXEMPTIONS = new Map([
  ...
  ['demo.paintline.kpiCycle', PAINTLINE_DEMO],
  ['demo.paintline.kpiCycleHint', PAINTLINE_DEMO],
  ['demo.paintline.kpiThroughput', PAINTLINE_DEMO],
  ['demo.paintline.kpiTotal', PAINTLINE_DEMO],
  ['demo.paintline.kpiBuffer', PAINTLINE_DEMO],
  ['demo.paintline.kpiBufferHint', PAINTLINE_DEMO],
  ...
  ['tools.finalSweep.workspace.modelDocumentTitle', BRAND_RENAME],
