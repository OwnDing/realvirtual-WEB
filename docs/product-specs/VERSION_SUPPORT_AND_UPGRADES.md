...
实现依据为 Accepted [`ADR-0010`](../adr/ADR-0010-versioned-upgrades.md)、[`CONTRACT-VERSION-COMPAT-001`](../contracts/VERSION_COMPATIBILITY.md)、[`RUNBOOK-VERSION-UPGRADE-001`](../runbooks/VERSION_UPGRADE.md) 和 [`EP-UPGRADE-001`](../exec-plans/active/EP-UPGRADE-001-versioned-upgrades.md)。
