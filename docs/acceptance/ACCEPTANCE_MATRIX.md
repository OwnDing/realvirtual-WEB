...
| 多语言 | Closed OD-002、Approved `PS-I18N-001`、Accepted `ADR-0001`；`zh-CN`/`en-US`、默认中文、AI 直接翻译 | ADR 已定义门禁范围；Active `EP-I18N-001` 负责落地盘点脚本、目录、回退链与黄金切片测试 | 产品规格与运行时 ADR 已批准、计划已激活；当前仍没有全局运行时或语言切换证据 | plan-active-implementation-pending |
