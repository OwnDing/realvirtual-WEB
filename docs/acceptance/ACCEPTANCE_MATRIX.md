...
| 多语言 | Closed OD-002、Approved `PS-I18N-001`；`zh-CN`/`en-US`、默认中文、AI 直接翻译 | Proposed `ADR-0001` 已定义候选门禁；待 ADR 接受和 `EP-I18N-001` 激活后落地目录与黄金切片测试 | 产品规格已批准；当前没有 Accepted 运行时 ADR、全局运行时或语言切换证据 | product-approved-architecture-pending |
