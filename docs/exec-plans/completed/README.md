...
- [`EP-UPGRADE-001-versioned-upgrades.md`](EP-UPGRADE-001-versioned-upgrades.md)：交付 N-2/bridge 与数据格式版本门、服务器/浏览器写前校验备份、失败恢复、迁移注册表、兼容合同和运维手册；2026-09-02 完成，并由 PR #9 远程五项 Gate 留证。
