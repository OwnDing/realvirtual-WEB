...
/**
 * order-manager-plugin.tsx — Order Manager (Warenkorb) for the XYvirtual WebViewer.
 *
...
export function OrderPanel() {
  ...
  const handleEmailExport = useCallback(() => {
    ...
    const subject = encodeURIComponent('Order Request - XYvirtual WebViewer');
    ...
    const body = encodeURIComponent(
      ...
      lines.join('\n') +
      '\n\nGenerated by XYvirtual WebViewer',
    );
