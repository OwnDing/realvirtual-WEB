 ...
 */
const DEFERRED_EN_NAMESPACES = ['projects', 'settings', 'connect', 'operator', 'authoring', 'assets'] as const;

export const RV_NAMESPACES = ['common', 'projects', 'settings', 'shell', 'connect', 'operator', 'authoring', 'assets', 'preboot', 'plugins', 'viewer'] as const;
